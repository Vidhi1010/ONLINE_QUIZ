...
class Quiz:
	...
	def buttons(self):
		...
		width=10,bg="green4",fg="white",font=("ariel",16,"bold"))
		...
		width=5,bg="red3", fg="white",font=("ariel",16," bold"))
	...
	def display_title(self):
		...
		title = Label(gui, text="QUIZ WORLD",
		width=50, bg="navy",fg="white", font=("ariel", 20, "bold"))
